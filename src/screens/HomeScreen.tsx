...
export default function HomeScreen({ navigation }: any) {
  ...
  const mainActions = [
    { id: 'write', icon: 'create', label: 'Quero escrever', desc: 'Escreva o que está sentindo', color: colors.primary, bg: colors.primaryBg, screen: 'Journal', params: { openModal: true } },
    ...
    { id: 'mood', icon: 'happy', label: 'Registrar humor', desc: 'Como está seu dia?', color: colors.accent, bg: darkMode ? '#4A3423' : '#FBECE3', screen: 'Journal', params: { openModal: true } },
